...
import ResourceSuccessModal from "./ResourceSuccessModel";
...
const AddResource: React.FC = () => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      await axios.post(
        "http://localhost:8096/terrasustain/gvt/add-resource",
        payload,
        {
          headers: {
      ...
      <main className="px-4 mx-72 max-w-7xl sm:px-6 lg:px-8">
        <div className="transition-all duration-700 mt-10">
          ...
          <p className="mt-2 text-lg text-gray-600 font-body">
            Improve awareness for protecting the environment with visual or text based resources.
          </p>
        </div>
        ...
        <div className="mt-9">
          ...
          >
            <h2 className="text-2xl font-semibold mb-8 text-center text-gray-800">
              Add Resources to raise awareness
            </h2>
            ...
            <div className="mb-6">
              ...
              >
                ...
                <option value="TEXT">Article / Books</option>
              </select>
            </div>
            ...
            <div className="mb-6">
              <label htmlFor="description" className="block text-gray-700 mb-2 font-medium">
                Resource Description <span className="text-red-500">*</span>
              </label>
              <textarea
                id="description"
